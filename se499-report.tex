...
The goal of this work is to add GNU Debugger support for \uCPPS and \CFA. To
achieve this goal for \uCPP, new extensions are written to provide additional
support for high-level constructs that are unknown to GNU Debugger. In addition to the work done for
\uCPP, many hooks are added in GNU Debugger to enable the addition of \CFAS
demangler.

This report assumes readers have some basic knowledge of compiler construction.
...
GNU Debugger's internal manual is used as a guide for the development of
adding a demangler for \CFA, and \CFA's main page\cite{reference13} for
background knowledge about the language.
}
